...
import static com.example.mentor.debitmaneger.DatabaseHelpher.DATABSE_NAME;
import static com.example.mentor.debitmaneger.userdashboard.REQUEST_CODE_CREATION;
import static com.example.mentor.debitmaneger.userdashboard.REQUEST_CODE_OPENING;
import static com.example.mentor.debitmaneger.userdashboard.REQUEST_CODE_SIGN_IN;
...
//    private static final String TAG = "Google Drive Activity";
    ...
    public RemoteBackup(userdashboard activity) {
...
//        Log.i(TAG, "Start sign in");
    ...
    private Task<Void> createFileIntentSender(DriveContents driveContents) {
        ...
        final String inFileName = activity.getDatabasePath(DATABSE_NAME).toString();
